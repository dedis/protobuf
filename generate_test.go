...
message test {
  ...
  optional sint64 oi = 51;
  optional sint32 oi32 = 52;
  optional sint64 oi64 = 53;
  optional uint32 ou32 = 54;
  optional uint64 ou64 = 55;
  optional float of32 = 56;
  optional double of64 = 57;
  optional bytes obytes = 58;
  optional string ostring = 59;
  optional test ostruct = 60;
  repeated bool sbool = 100 [packed=true];
  repeated sint64 si = 101;
  repeated sint32 si32 = 102 [packed=true];
  repeated sint64 si64 = 103 [packed=true];
  repeated uint32 su32 = 104 [packed=true];
  repeated uint64 su64 = 105 [packed=true];
  repeated sfixed32 ssx32 = 106 [packed=true];
  repeated sfixed64 ssx64 = 107 [packed=true];
  repeated fixed32 sux32 = 108 [packed=true];
  repeated ufixed64 sux64 = 109 [packed=true];
  repeated float sf32 = 110 [packed=true];
  repeated double sf64 = 111 [packed=true];
  repeated bytes sbytes = 112;
  repeated string sstring = 113;
  repeated emb sstruct = 114;
}
